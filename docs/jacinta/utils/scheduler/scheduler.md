...
[`Scheduler`](../../../../src/jacinta/utils/scheduler/scheduler.py) is an abstract component that maps each depth level of an [`NDSpace`](../ndspace/nd_space.md) tree to a floating-point value. It provides a depth-dependent mechanism for configuring parameters that may vary according to the precision requirements of different regions of the space.
