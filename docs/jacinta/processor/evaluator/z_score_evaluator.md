...
[`ZScoreEvaluator`](../../../../src/jacinta/processor/evaluator/z_score_evaluator.py) is an [`Evaluator`](evaluator.md) that normalizes raw feedback according to its z-score using online estimates of the mean and variance.
